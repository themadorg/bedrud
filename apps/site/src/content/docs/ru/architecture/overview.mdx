...
See [Server Architecture](/ru/docs/architecture/server) for details.
...
See [Web Frontend](/ru/docs/architecture/web) for details.
...
See [Android App](/ru/docs/architecture/android) for details.
...
See [iOS App](/ru/docs/architecture/ios) for details.
...
See [Desktop App](/ru/docs/architecture/desktop) for details.
...
See [Bot Agents](/ru/docs/architecture/agents) for details.
...
See [Deployment Guide](/ru/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/ru/docs/architecture/turn-server) - TURN relay architecture and configuration

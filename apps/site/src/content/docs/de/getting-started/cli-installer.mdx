...
Der Installer erkennt automatisch `windows_arm64` und lädt die native Binärdatei herunter. Wenn Sie eine Architektur erzwingen müssen, laden Sie das spezifische Zip-Archiv von [Releases](https://github.com/bedrud-ir/bedrud/releases) herunter.

...
**Konum:** `server/livekit.yaml` (geliştirme) veya `/etc/bedrud/livekit.yaml` (üretim)

<Tabs>
  <TabsList>
    <TabsTrigger value="production">Üretim / Harici (Standart)</TabsTrigger>
    <TabsTrigger value="development">Yerel Geliştirme (Loopback)</TabsTrigger>
  </TabsList>

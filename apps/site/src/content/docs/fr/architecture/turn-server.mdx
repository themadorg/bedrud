---
title: Serveur TURN
description: Configuration du relais TURN
order: 14
---
...
See [WebRTC Connectivity](/fr/docs/architecture/webrtc-connectivity) for the full connectivity stack.
...
- [LiveKit Integration](/fr/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Configuration Reference](/fr/docs/getting-started/configuration) - all config options
- [Internal TLS](/fr/docs/guides/internal-tls) - TLS for isolated networks

...
See the [Configuration Reference](/es/docs/getting-started/configuration) for all options.
...
See [Updating](/es/docs/getting-started/installation#updating) and [CLI Reference](/es/docs/getting-started/cli-reference#update--upgrade).

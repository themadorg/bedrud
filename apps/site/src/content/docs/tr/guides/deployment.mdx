...
Kurulumdan sonra TLS, init servisleri (systemd/OpenRC/SysV) ve veritabanını yapılandırmak için etkileşimli yükleyiciyi çalıştırın:
...
| Docker imajı (`ghcr.io/themadorg/bedrud`)              | GHCR'a gönderilen çok mimarili konteyner imajı    |

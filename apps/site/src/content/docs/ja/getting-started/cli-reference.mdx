---
title: CLI リファレンス
description: コマンドラインインターフェイスのドキュメント
order: 5
---
...
**Related docs:** [Installation Guide](/ja/docs/getting-started/installation) • [Deployment Guide](/ja/docs/guides/deployment) • [Backend Deployment Logic](/ja/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/ja/docs/getting-started/installation#updating) • [Appliance Mode](/ja/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/ja/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/ja/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/ja/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/ja/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/ja/docs/guides/deployment) - Full deployment options including init system services

...
See [Server Architecture](/fa/docs/architecture/server) for details.
...
See [Web Frontend](/fa/docs/architecture/web) for details.
...
See [Android App](/fa/docs/architecture/android) for details.
...
See [iOS App](/fa/docs/architecture/ios) for details.
...
See [Desktop App](/fa/docs/architecture/desktop) for details.
...
See [Bot Agents](/fa/docs/architecture/agents) for details.
...
See [Deployment Guide](/fa/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/fa/docs/architecture/turn-server) - TURN relay architecture and configuration

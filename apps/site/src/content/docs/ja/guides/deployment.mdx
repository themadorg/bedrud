...
| [Appliance Mode](/ja/docs/guides/appliance) | Single-binary all-in-one setup |
...
See the [Package Installation guide](/ja/docs/guides/packages) for full instructions, including adding the apt GPG key and repository.
...
See the [Installation Guide](/ja/docs/getting-started/installation) for all installation scenarios.
...
See the [Docker Guide](/ja/docs/guides/docker) for full details including volumes, configuration, and Docker Compose.

...
После установки запустите интерактивный установщик для настройки TLS, init-сервисов (systemd/OpenRC/SysV) и базы данных:
...
| Docker image (`ghcr.io/themadorg/bedrud`) | Мультиархитектурный контейнерный образ в GHCR |

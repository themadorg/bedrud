...
**مکان:** `server/livekit.yaml` (توسعه) یا `/etc/bedrud/livekit.yaml` (تولید)

<Tabs>
  <TabsList>
    <TabsTrigger value="production">تولید / خارجی (استاندارد)</TabsTrigger>
    <TabsTrigger value="development">توسعه محلی (Loopback)</TabsTrigger>
  </TabsList>

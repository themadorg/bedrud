...
**Расположение:** `server/livekit.yaml` (разработка) или `/etc/bedrud/livekit.yaml` (production)

<Tabs>
  <TabsList>
    <TabsTrigger value="production">Продакшен / Внешний (Стандарт)</TabsTrigger>
    <TabsTrigger value="development">Локальная разработка (Loopback)</TabsTrigger>
  </TabsList>

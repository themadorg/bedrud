...
حمّل حزمة `.deb` مباشرة من [أحدث إصدار على GitHub](https://github.com/themadorg/bedrud/releases/latest):
...
حمّل حزمة `.rpm` من [أحدث إصدار على GitHub](https://github.com/themadorg/bedrud/releases/latest):
...
<Tabs>
  ...
  <TabsContent value="nsis">
    حمّل وشغّل المثبّت من [أحدث إصدار](https://github.com/themadorg/bedrud/releases/latest):
...
| `HOMEBREW_TAP_TOKEN` | Homebrew tap | رمز PAT من GitHub مع صلاحية الكتابة إلى `themadorg/homebrew-bedrud` |

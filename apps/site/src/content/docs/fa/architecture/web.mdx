...
3. **تزریق خودکار** – `authFetch` هر فراخوانی API را می‌پوشاند و سرآیند `Authorization: Bearer` را می‌افزاید (برای درخواست‌های تغییردهندهٔ حالت لازم؛ سرور جهش فقط-کوکی را رد می‌کند)
...
End-user how-tos: [Using Bedrud](/fa/docs/using/joining-a-meeting) (start at joining, then stage, whiteboard, chat, and controls).

...
/** Persian/Arabic/Hebrew text uses Shabnam (loaded in Bedrud web shell). */
export const BEDRUD_RTL_FONT_FAMILY =
  "Shabnam, ui-sans-serif, system-ui, sans-serif";
...
export const getFontFamilyString = ({
  ...
  if (content && isRTL(content)) {
    return `${BEDRUD_RTL_FONT_FAMILY}, ${WINDOWS_EMOJI_FALLBACK_FONT}`;
  }

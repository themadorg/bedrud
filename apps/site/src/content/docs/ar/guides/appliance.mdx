...
See the [Configuration Reference](/ar/docs/getting-started/configuration) for all options.
...
See [Updating](/ar/docs/getting-started/installation#updating) and [CLI Reference](/ar/docs/getting-started/cli-reference#update--upgrade).

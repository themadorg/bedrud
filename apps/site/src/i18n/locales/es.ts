export default {
  ...
  downloadPage: {
    ...
    dockerRunDesc: "Ejecuta en un contenedor con Docker o Podman.",
    dockerComposeDesc: "Despliega con Docker Compose para gestión fácil.",
    dockerQuickStart: "Inicio rápido",
    dockerQuickStartDesc:
      "Descarga y ejecuta el servidor Bedrud con un solo comando. Interfaz web en el puerto 8090, WebRTC en el 7880.",
    dockerCopyRun: "Copiar docker run",
    dockerPodmanDesc:
      "Alternativa sin root a Docker. Mismos comandos, solo reemplaza docker por podman.",
    dockerVariantsTitle: "Variantes de imagen",
    dockerVariantsDesc:
      "Elige la imagen base según tus requisitos de seguridad y tamaño.",
    dockerVariantDefault: "por defecto",
    dockerVariantSmall: "más pequeña",
    dockerVariantMinimal: "superficie de ataque mínima",
    dockerPortsTitle: "Puertos y volúmenes",
    dockerPortWeb: "Interfaz web y API",
    dockerPortRTC: "WebRTC (medios)",
    dockerVolumeDesc: "Configuración y base de datos SQLite",
    dockerEnvDesc: "CONFIG_PATH, puerto de escucha, etc.",
    dockerPortUDP: "Puertos de medios WebRTC (UDP)",
    dockerGuide: "Guía completa de Docker",

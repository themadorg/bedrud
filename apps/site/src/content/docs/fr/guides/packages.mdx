...
Téléchargez le paquet `.deb` directement depuis la [dernière release GitHub](https://github.com/themadorg/bedrud/releases/latest) :
...
Téléchargez le paquet `.rpm` depuis la [dernière release GitHub](https://github.com/themadorg/bedrud/releases/latest) :
...
|-----|------|--------|
| `:latest` | Debian | ~45 Mo |
| `:latest-alpine` | Alpine | ~15 Mo |
| `:latest-distroless` | Distroless | ~25 Mo |
...
<Tabs>
  ...
  <TabsContent value="nsis">
    Téléchargez et exécutez l'installateur depuis la [dernière release](https://github.com/themadorg/bedrud/releases/latest) :
...
| `HOMEBREW_TAP_TOKEN` | Homebrew tap | GitHub PAT avec accès en écriture à `themadorg/homebrew-bedrud` |

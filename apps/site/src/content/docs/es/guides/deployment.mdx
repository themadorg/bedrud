...
Después de la instalación, ejecuta el instalador interactivo para configurar TLS, servicios init (systemd/OpenRC/SysV) y la base de datos:
...
| Imagen Docker (`ghcr.io/themadorg/bedrud`) | Imagen contenedora multi-arquitectura publicada en GHCR |

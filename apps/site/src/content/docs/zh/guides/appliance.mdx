...
See the [Configuration Reference](/zh/docs/getting-started/configuration) for all options.
...
See [Updating](/zh/docs/getting-started/installation#updating) and [CLI Reference](/zh/docs/getting-started/cli-reference#update--upgrade).

...
See [Server Architecture](/es/docs/architecture/server) for details.
...
See [Web Frontend](/es/docs/architecture/web) for details.
...
See [Android App](/es/docs/architecture/android) for details.
...
See [iOS App](/es/docs/architecture/ios) for details.
...
See [Desktop App](/es/docs/architecture/desktop) for details.
...
See [Bot Agents](/es/docs/architecture/agents) for details.
...
See [Deployment Guide](/es/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/es/docs/architecture/turn-server) - TURN relay architecture and configuration

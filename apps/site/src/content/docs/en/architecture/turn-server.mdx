...
**File:** `server/livekit.yaml` (dev) or `/etc/bedrud/livekit.yaml` (production)
...
<Tabs>
  <TabsList>
    <TabsTrigger value="production">Production / External (Standard)</TabsTrigger>
    <TabsTrigger value="development">Local Development (Loopback)</TabsTrigger>
  </TabsList>

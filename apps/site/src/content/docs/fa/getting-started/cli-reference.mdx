...
**Related docs:** [Installation Guide](/fa/docs/getting-started/installation) • [Deployment Guide](/fa/docs/guides/deployment) • [Backend Deployment Logic](/fa/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/fa/docs/getting-started/installation#updating) • [Appliance Mode](/fa/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/fa/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/fa/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/fa/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/fa/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/fa/docs/guides/deployment) - Full deployment options including init system services

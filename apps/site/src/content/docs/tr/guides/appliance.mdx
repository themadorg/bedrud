...
See the [Configuration Reference](/tr/docs/getting-started/configuration) for all options.
...
See [Updating](/tr/docs/getting-started/installation#updating) and [CLI Reference](/tr/docs/getting-started/cli-reference#update--upgrade).

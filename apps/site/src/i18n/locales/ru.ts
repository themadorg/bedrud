export default {
  meta: {
    ...
    description:
      "Self-hosted видеовстречи. Один бинарник. 512 МБ ОЗУ. Open source, лицензия AGPL-3.0.",
  },
  nav: {
    home: "Главная",
  ...
  hero: {
    badge: "Open Source · Лицензия AGPL-3.0",
  ...
  openSource: {
    ...
    subtitle:
      "Каждая строка кода публична. Изучайте, проверяйте, вносите вклад или форкайте и стройте свое. Лицензия AGPL-3.0 - используйте коммерчески или как угодно.",
    license: "AGPL-3.0",
  ...
  faq: {
    ...
    pricing: {
      ...
      answer:
        "Полностью. Лицензия AGPL-3.0, никаких ограничений функций, никаких кнопок 'Связаться с отделом продаж'. Исходный код открыт. Размещайте самостоятельно и платите только за сервер — обычно $5/мес.",
    },
    mobile: {
  ...
  featuresPage: {
    ...
    audio: {
      ...
      description:
        "Подавление шума RNNoise включено по умолчанию. Опциональная связка с Krisp выключена — её нужно включить самостоятельно и убедиться в наличии лицензии Krisp (например LiveKit Cloud или коммерческая лицензия Krisp). Bedrud не предоставляет бесплатную лицензию Krisp.",
    },
    whiteboard: {
  ...
  terms: {
    meta: {
      ...
      description:
        "Условия использования сайта. Self-hosted по лицензии AGPL-3.0.",
    },
    ...
    services: {
      title: "Услуги",
      content: "Предоставляем документацию и демо. ПО доступно под AGPL-3.0.",
    },
    accounts: {
      title: "Аккаунты",
    ...
    intellectualProperty: {
      title: "Лицензия",
      content: "Bedrud лицензирован под AGPL-3.0.",
    },
    termination: {
      title: "Доступ",
  ...
  docs: {
    ...
    sidebarItems: {
      ...
      "architecture/e2ee": "Сквозное шифрование",
  ...
  downloadPage: {
    ...
    dockerRunDesc: "Запустить в контейнере Docker или Podman.",
    dockerComposeDesc:
      "Развёртывание с Docker Compose для удобного управления.",
    dockerQuickStart: "Быстрый старт",
    dockerQuickStartDesc:
      "Запустите сервер Bedrud одной командой. Веб-интерфейс на порту 8090, WebRTC на порту 7880.",
    dockerCopyRun: "Копировать docker run",
    dockerPodmanDesc:
      "Альтернатива Docker без прав root. Те же команды, замените docker на podman.",
    dockerVariantsTitle: "Варианты образа",
    dockerVariantsDesc:
      "Выберите базовый образ по требованиям безопасности и размера.",
    dockerVariantDefault: "по умолчанию",
    dockerVariantSmall: "меньший",
    dockerVariantMinimal: "минимальная поверхность атаки",
    dockerPortsTitle: "Порты и тома",
    dockerPortWeb: "Веб-интерфейс и API",
    dockerPortRTC: "WebRTC (медиа)",
    dockerVolumeDesc: "Конфигурация и база SQLite",
    dockerEnvDesc: "CONFIG_PATH, порт и т.д.",
    dockerPortUDP: "Медиапорты WebRTC (UDP)",
    dockerGuide: "Полное руководство по Docker",
    platform: {
      linux: "Linux",
      mac: "macOS",
      windows: "Windows",
  ...
  e2eePage: {
    meta: {
      title: "Сквозное шифрование - Bedrud",
      description:
        "Bedrud поддерживает дополнительное сквозное шифрование для каждой комнаты. Архитектура нулевого разглашения — ваш сервер передает зашифрованные медиаданные, но никогда не владеет ключами.",
    },
    badge: "Конфиденциальность Превыше Всего",
    ...
    zeroKnowledge: {
      ...
      items: {
        ...
        workerIsolation: "Изоляция в Web Worker",
        workerIsolationDesc:
    ...
    architecture: {
      ...
      toggleLabel: "Шифрование",
      disabledMode: "Стандартный",
      enabledMode: "E2EE",
      sender: "Отправитель",
      clientA: "Клиент A",
      mediaFeed: "Медиапоток",
      frameSmile: "Данные кадра",
      outboundPipeline: "Исходящий конвейер",
      plaintextPipeline: "Кадры в открытом виде",
      encryptPipeline: "🔒 Шифрование...",
      inspectableStatus: "🔍 Доступно для просмотра",
      blindStatus: "🔒 Слепая передача",
      sfuNode: "LiveKit SFU",
      relayDescription: "Передача зашифрованных кадров",
      readableServer: "Сервер может читать кадры (открытый текст)",
      bypassedServer: "Сервер передает вслепую (зашифровано)",
      sfuStorage: "Конвейер SFU",
      frameClear: "Кадр [clear]",
      frameCipher: "Кадр [cipher]",
      receiver: "Получатель",
      clientB: "Клиент B",
      decodedOutput: "Декодированный вывод",
      inboundPipeline: "Входящий конвейер",
      decryptPipeline: "🔓 Расшифровка...",
      disclaimerStandard:
      ...
      disclaimerE2ee:
        "Режим E2EE: SFU передает зашифрованные кадры без расшифровки. Только участники могут декодировать медиа.",
    },
    platforms: {
    ...
    feature: {
      ...
      items: {
        ...
        openSource: {
          title: "Полный аудит кода",
          description:
            "Каждая строка кода шифрования — от генерации ключа до трансформации кадров — открыта под лицензией AGPL-3.0.",
        },
      },
    },
    cta: {

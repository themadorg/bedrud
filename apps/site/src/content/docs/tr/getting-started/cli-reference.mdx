---
title: CLI Referansı
description: Komut satırı arayüzü belgelendirmesi
order: 5
---
...
**Related docs:** [Installation Guide](/tr/docs/getting-started/installation) • [Deployment Guide](/tr/docs/guides/deployment) • [Backend Deployment Logic](/tr/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/tr/docs/getting-started/installation#updating) • [Appliance Mode](/tr/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/tr/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/tr/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/tr/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/tr/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/tr/docs/guides/deployment) - Full deployment options including init system services

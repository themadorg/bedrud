---
title: 贡献指南
description: 如何为 Bedrud 贡献
order: 34
---

Contributions to Bedrud are welcome. This guide covers the process for submitting changes.

> **Note:** The canonical contributing guide is at the repository root: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/master/CONTRIBUTING.md). This page is archived for reference only.
...
See the [Development Workflow](/zh/docs/guides/development) for detailed setup instructions.

## Project Structure

| Directory       | Language         | Description                      |
|-----------------|------------------|----------------------------------|
| `server/`       | Go               | Backend API, embedded LiveKit, recording system, webhook dispatch |
...
By contributing, you agree that your contributions will be licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0)](https://github.com/themadorg/bedrud/blob/master/LICENSE).

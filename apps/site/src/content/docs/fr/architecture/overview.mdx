...
See [Server Architecture](/fr/docs/architecture/server) for details.
...
See [Web Frontend](/fr/docs/architecture/web) for details.
...
See [Android App](/fr/docs/architecture/android) for details.
...
See [iOS App](/fr/docs/architecture/ios) for details.
...
See [Desktop App](/fr/docs/architecture/desktop) for details.
...
See [Bot Agents](/fr/docs/architecture/agents) for details.
...
See [Deployment Guide](/fr/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/fr/docs/architecture/turn-server) - TURN relay architecture and configuration

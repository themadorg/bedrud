...
For deep TURN troubleshooting, see the [TURN Server Guide](/es/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/es/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/es/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/es/docs/architecture/overview) - full system architecture

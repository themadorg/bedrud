...
Après l'installation, exécutez l'installateur interactif pour configurer TLS, les services init (systemd/OpenRC/SysV) et la base de données :
...
| Image Docker (`ghcr.io/themadorg/bedrud`) | Image conteneur multi-arch pushée sur GHCR |

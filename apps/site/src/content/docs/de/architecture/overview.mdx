...
See [Server Architecture](/de/docs/architecture/server) for details.
...
See [Web Frontend](/de/docs/architecture/web) for details.
...
See [Android App](/de/docs/architecture/android) for details.
...
See [iOS App](/de/docs/architecture/ios) for details.
...
See [Desktop App](/de/docs/architecture/desktop) for details.
...
See [Bot Agents](/de/docs/architecture/agents) for details.
...
See [Deployment Guide](/de/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/de/docs/architecture/turn-server) - TURN relay architecture and configuration

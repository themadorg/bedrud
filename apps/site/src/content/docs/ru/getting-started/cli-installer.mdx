...
Установщик автоматически обнаруживает `windows_arm64` и загружает нативный бинарный файл. Если необходимо принудительно выбрать архитектуру, загрузите конкретный zip-архив со страницы [Releases](https://github.com/bedrud-ir/bedrud/releases).

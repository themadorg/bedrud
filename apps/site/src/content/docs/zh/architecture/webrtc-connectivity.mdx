---
title: WebRTC 连接
description: STUN/ICE/TURN 与媒体路由
order: 13
---
...
For deep TURN troubleshooting, see the [TURN Server Guide](/zh/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/zh/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/zh/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/zh/docs/architecture/overview) - full system architecture

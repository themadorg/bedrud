...
const SHOTS: Shot[] = [
  ...
  {
    src: "/preview/gallery/admin-overview__dark__desktop.png",
  ...
  {
    src: "/preview/gallery/admin-overview__light__desktop.png",
    title: "Admin overview",
    category: "admin",
    theme: "light",
    device: "desktop",
  ...
  {
    src: "/preview/gallery/admin-settings-auth__dark__desktop.png",
  ...
  {
    src: "/preview/gallery/admin-settings-auth__light__desktop.png",
    title: "Admin settings",
    category: "admin",
    theme: "light",
    device: "desktop",

...
See the [Configuration Reference](/ja/docs/getting-started/configuration) for all options.
...
See [Updating](/ja/docs/getting-started/installation#updating) and [CLI Reference](/ja/docs/getting-started/cli-reference#update--upgrade).

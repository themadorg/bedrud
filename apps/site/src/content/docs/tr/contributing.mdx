...
> **Not:** Resmi katkıda bulunma rehberi depo kök dizinindedir: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). Bu sayfa yalnızca referans amacıyla arşivlenmiştir.
...
[GitHub Issues](https://github.com/themadorg/bedrud/issues) üzerinden şu bilgilerle sorun bildirebilirsiniz:
...
Katkıda bulunarak, katkılarınızın [Apache License 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE) kapsamında lisanslanmasını kabul etmiş olursunuz.

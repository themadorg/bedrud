...
See [Server Architecture](/ar/docs/architecture/server) for details.
...
See [Web Frontend](/ar/docs/architecture/web) for details.
...
See [Android App](/ar/docs/architecture/android) for details.
...
See [iOS App](/ar/docs/architecture/ios) for details.
...
See [Desktop App](/ar/docs/architecture/desktop) for details.
...
See [Bot Agents](/ar/docs/architecture/agents) for details.
...
See [Deployment Guide](/ar/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/ar/docs/architecture/turn-server) - TURN relay architecture and configuration

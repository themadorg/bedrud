...
See [Server Architecture](/tr/docs/architecture/server) for details.
...
See [Web Frontend](/tr/docs/architecture/web) for details.
...
See [Android App](/tr/docs/architecture/android) for details.
...
See [iOS App](/tr/docs/architecture/ios) for details.
...
See [Desktop App](/tr/docs/architecture/desktop) for details.
...
See [Bot Agents](/tr/docs/architecture/agents) for details.
...
See [Deployment Guide](/tr/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/tr/docs/architecture/turn-server) - TURN relay architecture and configuration

---
title: 机器人代理
description: 用于流媒体内容的 Python 机器人
order: 12
---
...
> See [Music Agent README](https://github.com/themadorg/bedrud/tree/master/agents/music_agent) for setup and usage instructions.
...
> See [Radio Agent README](https://github.com/themadorg/bedrud/tree/master/agents/radio_agent) for setup and usage instructions.
...
> See [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/master/agents/video_stream_agent) for setup and usage instructions.
...
- [Music Agent README](https://github.com/themadorg/bedrud/tree/master/agents/music_agent) - setup and usage
- [Radio Agent README](https://github.com/themadorg/bedrud/tree/master/agents/radio_agent) - setup and usage
- [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/master/agents/video_stream_agent) - setup and usage

...
Prints the installed version and the version it is moving to before stopping anything, then replaces the binary, runs versioned install migrations and DB AutoMigrate, refreshes init units, and restarts services. See [Updating](/zh/docs/getting-started/installation#updating).
...
- [Deployment Guide](/zh/docs/guides/deployment) - full production deployment instructions
- [Appliance Mode](/zh/docs/guides/appliance) - single-binary setup reference

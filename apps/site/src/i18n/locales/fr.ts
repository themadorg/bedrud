export default {
  ...
  docs: {
    ...
    sidebarItems: {
      ...
      "using/account-and-settings": "Compte et paramètres",
      "using/dashboard-and-rooms": "Tableau de bord et salles",
      "using/joining-a-meeting": "Rejoindre une réunion",
      "using/stage-mode": "Mode scène",
      "using/whiteboard": "Tableau blanc collaboratif",
      "using/youtube-watch": "YouTube Watch",
      "using/chat": "Chat en réunion",
      "using/audio-and-push-to-talk": "Audio et push-to-talk",
      "using/meeting-controls": "Contrôles de réunion",
  ...
  downloadPage: {
    ...
    dockerRunDesc: "Exécuter dans un conteneur avec Docker ou Podman.",
    dockerComposeDesc:
      "Déployer avec Docker Compose pour une gestion simplifiée.",
    dockerQuickStart: "Démarrage rapide",
    dockerQuickStartDesc:
      "Lancez le serveur Bedrud en une seule commande. Interface web sur le port 8090, WebRTC sur le 7880.",
    dockerCopyRun: "Copier docker run",
    dockerPodmanDesc:
      "Alternative rootless à Docker. Mêmes commandes, remplacez simplement docker par podman.",
    dockerVariantsTitle: "Variantes d'image",
    dockerVariantsDesc:
      "Choisissez l'image de base selon vos exigences de sécurité et de taille.",
    dockerVariantDefault: "par défaut",
    dockerVariantSmall: "plus petite",
    dockerVariantMinimal: "surface d'attaque minimale",
    dockerPortsTitle: "Ports et volumes",
    dockerPortWeb: "Interface web et API",
    dockerPortRTC: "WebRTC (média)",
    dockerVolumeDesc: "Configuration et base SQLite",
    dockerEnvDesc: "CONFIG_PATH, port d'écoute, etc.",
    dockerPortUDP: "Ports média WebRTC (UDP)",
    dockerGuide: "Guide Docker complet",
  ...
  featuresPage: {
    ...
    audio: {
      ...
      description:
        "Suppression de bruit RNNoise incluse par défaut. Le branchement Krisp optionnel est désactivé par défaut — vous devez l'activer et disposer d'une licence Krisp valide (ex. LiveKit Cloud ou licence commerciale Krisp). Bedrud n'inclut pas de licence Krisp gratuite.",
    },
    whiteboard: {

...
> **Hinweis:** Der maßgebliche Leitfaden zum Mitwirken befindet sich im Repository-Root: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). Diese Seite dient lediglich als Referenz.
...
Melden Sie Probleme auf [GitHub Issues](https://github.com/themadorg/bedrud/issues) mit folgenden Angaben:
...
Durch Ihren Beitrag stimmen Sie zu, dass Ihre Beiträge unter der [Apache License 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE) lizenziert werden.

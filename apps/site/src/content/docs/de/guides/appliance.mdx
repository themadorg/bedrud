...
See the [Configuration Reference](/de/docs/getting-started/configuration) for all options.
...
See [Updating](/de/docs/getting-started/installation#updating) and [CLI Reference](/de/docs/getting-started/cli-reference#update--upgrade).

...
For deep TURN troubleshooting, see the [TURN Server Guide](/ar/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/ar/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/ar/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/ar/docs/architecture/overview) - full system architecture

...
پس از نصب، نصب‌کننده تعاملی را برای پیکربندی TLS، init سرویس‌ها (systemd/OpenRC/SysV) و دیتابیس اجرا کنید:
...
| تصویر Docker (`ghcr.io/themadorg/bedrud`) | تصویر کانتینر چندمعماری فشرده شده به GHCR |

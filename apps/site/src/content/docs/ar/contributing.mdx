...
> **ملاحظة:** دليل المساهمة الرسمي موجود في جذر المستودع: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). هذه الصفحة محفوظة للرجوع إليها فقط.
...
قدّم مشكلاتك على [GitHub Issues](https://github.com/themadorg/bedrud/issues) مع:
...
بمساهمتك، فإنك توافق على أن مساهماتك ستكون مرخصة بموجب [Apache License 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE).

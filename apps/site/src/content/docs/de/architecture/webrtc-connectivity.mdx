...
For deep TURN troubleshooting, see the [TURN Server Guide](/de/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/de/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/de/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/de/docs/architecture/overview) - full system architecture

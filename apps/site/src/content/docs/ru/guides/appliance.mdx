...
See the [Configuration Reference](/ru/docs/getting-started/configuration) for all options.
...
See [Updating](/ru/docs/getting-started/installation#updating) and [CLI Reference](/ru/docs/getting-started/cli-reference#update--upgrade).

...
**Related docs:** [Installation Guide](/fr/docs/getting-started/installation) • [Deployment Guide](/fr/docs/guides/deployment) • [Backend Deployment Logic](/fr/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/fr/docs/getting-started/installation#updating) • [Appliance Mode](/fr/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/fr/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/fr/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/fr/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/fr/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/fr/docs/guides/deployment) - Full deployment options including init system services

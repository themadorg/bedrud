...
**Related docs:** [Installation Guide](/es/docs/getting-started/installation) • [Deployment Guide](/es/docs/guides/deployment) • [Backend Deployment Logic](/es/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/es/docs/getting-started/installation#updating) • [Appliance Mode](/es/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/es/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/es/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/es/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/es/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/es/docs/guides/deployment) - Full deployment options including init system services

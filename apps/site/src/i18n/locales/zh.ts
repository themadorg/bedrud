export default {
  ...
  downloadPage: {
    ...
    dockerRunDesc: "使用 Docker 或 Podman 容器运行。",
    dockerComposeDesc: "使用 Docker Compose 部署，方便管理。",
    dockerQuickStart: "快速开始",
    dockerQuickStartDesc:
      "一条命令启动 Bedrud 服务器。Web 界面在端口 8090，WebRTC 在端口 7880。",
    dockerCopyRun: "复制 docker run",
    dockerPodmanDesc:
      "Docker 的无 root 替代方案。命令相同，只需将 docker 替换为 podman。",
    dockerVariantsTitle: "镜像变体",
    dockerVariantsDesc: "根据安全和大小要求选择合适的基礎镜像。",
    dockerVariantDefault: "默认",
    dockerVariantSmall: "更小",
    dockerVariantMinimal: "最小攻击面",
    dockerPortsTitle: "端口和卷",
    dockerPortWeb: "Web 界面和 API",
    dockerPortRTC: "WebRTC（媒体）",
    dockerVolumeDesc: "配置和 SQLite 数据库",
    dockerEnvDesc: "CONFIG_PATH、监听端口等",
    dockerPortUDP: "WebRTC 媒体端口（UDP）",
    dockerGuide: "完整 Docker 指南",
    repoSetup: "需要仓库配置",

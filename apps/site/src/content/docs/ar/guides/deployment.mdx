...
| [Appliance Mode](/ar/docs/guides/appliance) | Single-binary all-in-one setup |
...
See the [Package Installation guide](/ar/docs/guides/packages) for full instructions, including adding the apt GPG key and repository.
...
See the [Installation Guide](/ar/docs/getting-started/installation) for all installation scenarios.
...
See the [Docker Guide](/ar/docs/guides/docker) for full details including volumes, configuration, and Docker Compose.

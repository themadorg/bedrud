...
بعد التثبيت، شغّل المثبّت التفاعلي لإعداد TLS وخدمات init (systemd/OpenRC/SysV) وقاعدة البيانات:
...
| صورة Docker (`ghcr.io/themadorg/bedrud`) | صورة حاوية متعددة البُنى مدفوعة إلى GHCR |

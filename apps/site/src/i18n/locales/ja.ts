export default {
  ...
  openSource: {
    ...
    subtitle:
      "すべてのコードが公開されています。検査、監査、貢献、またはフォーク可能。AGPL-3.0ライセンス - 商用・個人利用自由。",
    license: "AGPL-3.0",
    github: "GitHub で見る",
    docs: "ドキュメントを読む",
  },
  ...
  faq: {
    ...
    pricing: {
      question: "本当に無料ですか？",
      answer:
        "完全に無料です。AGPL-3.0ライセンス、機能制限なし、「営業に連絡」ボタンなし。ソースコードは公開されています。自分でホストして、サーバー代だけ払えばOK — 通常月額5ドル。",
    },
    mobile: {
  ...
  terms: {
    meta: {
      title: "利用規約 - Bedrud",
      description:
        "bedrud.org ウェブサイトと公開デモの利用規約。セルフホストユーザーは AGPL-3.0 ライセンスに従います。",
    },
    title: "利用規約",
    lastUpdated: "最終更新日：2026年4月17日",
    intro:
      "本規約は bedrud.org ウェブサイトと bedrud.xyz の公開デモインスタンスを対象としています。Bedrud をダウンロードしてセルフホストする場合、AGPL-3.0 ライセンスが適用されます。",
    acceptance: {
    ...
    services: {
      ...
      content:
        "当方はドキュメントとダウンロードリンクがあるウェブサイトと、ソフトウェア評価用の公開デモインスタンスを提供しています。ビデオ会議ソフトウェア自体は AGPL-3.0 ライセンスのオープンソースです。ダウンロード、改変、自前での実行が可能です。",
    },
    accounts: {
      title: "アカウント",
      content:
    ...
    intellectualProperty: {
      title: "オープンソースライセンス",
      content:
        "Bedrud は AGPL-3.0 ライセンスです。商用を含めて使用、改変、配布が可能です。Bedrud の名前とロゴは theMadOrg の商標です。ソフトウェアを指す用途には使用できますが、プロジェクトとの関係を誤って表現する目的には使用できません。",
    },
    termination: {
      title: "アクセス",
      content:
        "悪用があった場合、公開デモへのアクセスをいつでも取り消すことができます。必要に応じてウェブサイトを閉鎖することもあります。ただし、バイナリをダウンロードした時点で、AGPL-3.0 ライセンスに基づきあなたのものになります。これは取り消せません。",
    },
    liability: {
      title: "無保証",
      content:
        "Bedrud は現状のまま提供されます。すべての環境で完璧に動作することを保証しません。ダウンタイム、データ損失、ソフトウェア使用に起因する損害について責任を負いません。完全な法的テキストは AGPL-3.0 ライセンスをご覧ください。",
    },
    governingLaw: {
      title: "準拠法",
      content:
  ...
  downloadPage: {
    ...
    dockerRunDesc: "DockerまたはPodmanのコンテナで実行。",
    dockerComposeDesc: "Docker Composeで簡単に管理・デプロイ。",
    dockerQuickStart: "クイックスタート",
    dockerQuickStartDesc:
      "コマンド1つでBedrudサーバーを起動。Web UIはポート8090、WebRTCはポート7880。",
    dockerCopyRun: "docker runをコピー",
    dockerPodmanDesc:
      "Dockerのルートレス代替。同じコマンドで、dockerをpodmanに置き換えるだけ。",
    dockerVariantsTitle: "イメージバリアント",
    dockerVariantsDesc:
      "セキュリティとサイズの要件に合ったベースイメージを選択。",
    dockerVariantDefault: "デフォルト",
    dockerVariantSmall: "より小さい",
    dockerVariantMinimal: "最小攻撃面",
    dockerPortsTitle: "ポートとボリューム",
    dockerPortWeb: "Web UIとAPI",
    dockerPortRTC: "WebRTC（メディア）",
    dockerVolumeDesc: "設定とSQLiteデータベース",
    dockerEnvDesc: "CONFIG_PATH、リスニングポートなど",
    dockerPortUDP: "WebRTCメディアポート（UDP）",
    dockerGuide: "Dockerガイド（詳細）",
    platform: {
      linux: "Linux",
      mac: "macOS",
      windows: "Windows",
    ...
    feature: {
      ...
      items: {
        ...
        openSource: {
          title: "完全な監査可能性",
          description:
            "鍵生成からフレーム変換まで、暗号化パイプラインのすべてのコードがAGPL-3.0ライセンスでオープンソースとして公開されています。",
        },
      },
    },
    cta: {

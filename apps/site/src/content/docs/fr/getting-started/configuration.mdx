...
**Emplacement :** `server/livekit.yaml` (développement) ou `/etc/bedrud/livekit.yaml` (production)

<Tabs>
  <TabsList>
    <TabsTrigger value="production">Production / Externe (Standard)</TabsTrigger>
    <TabsTrigger value="development">Développement Local (Loopback)</TabsTrigger>
  </TabsList>

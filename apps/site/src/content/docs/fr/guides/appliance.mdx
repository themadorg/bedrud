...
See the [Configuration Reference](/fr/docs/getting-started/configuration) for all options.
...
See [Updating](/fr/docs/getting-started/installation#updating) and [CLI Reference](/fr/docs/getting-started/cli-reference#update--upgrade).

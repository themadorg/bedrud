...
For deep TURN troubleshooting, see the [TURN Server Guide](/ru/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/ru/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/ru/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/ru/docs/architecture/overview) - full system architecture

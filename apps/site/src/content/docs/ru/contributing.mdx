...
> **Примечание:** Каноническое руководство по участию находится в корне репозитория: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). Эта страница оставлена только для справки.
...
Создавайте issues на [GitHub Issues](https://github.com/themadorg/bedrud/issues) с указанием:
...
Внося вклад, вы соглашаетесь с тем, что ваши изменения будут лицензированы под [Apache License 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE).

...
> **Note :** Le guide de contribution canonique se trouve à la racine du dépôt : [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). Cette page est archivée pour référence uniquement.
...
Signalez les problèmes sur [GitHub Issues](https://github.com/themadorg/bedrud/issues) avec :
...
En contribuant, vous acceptez que vos contributions seront licenciées sous la [Licence Apache 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE).

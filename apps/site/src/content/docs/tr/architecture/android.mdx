...
### Ürün yüzeyi (kullanıcıların aldığı)

| Alan | Davranış |
|------|----------|
| Auth | Giriş / kayıt (desteklendiği yerde passkey'ler) |
| Dashboard | Oda listesi; katıldıktan sonra **son odalar** |
| Deep links | Yapıştırılan / açılan oda URL'leri doğru odaya çözülür |
| Meeting | Katıl, sessize al, ayrıl; kullanılabilir kontrol chrome'u |
| Stage / share | Cihaz izin verdiğinde sahne katmanı ve ekran paylaşımı yolu |
| Telecom | Kendi yönettiği arama bağlantısı; bağlantı kesince toplantı temiz biter |
| RTL | `fa` / `ar` yerel ayarları ve Shabnam — chrome kesilmemeli |

Paylaşılan ürün kavramları (web'de sahne, sohbet, beyaz tahta) [Bedrud'u Kullanma](/tr/docs/using/joining-a-meeting) altında belgelenir. Web ile özellik eşliği sürüme göre değişebilir.

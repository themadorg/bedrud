...
**Related docs:** [Installation Guide](/ru/docs/getting-started/installation) • [Deployment Guide](/ru/docs/guides/deployment) • [Backend Deployment Logic](/ru/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/ru/docs/getting-started/installation#updating) • [Appliance Mode](/ru/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/ru/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/ru/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/ru/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/ru/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/ru/docs/guides/deployment) - Full deployment options including init system services

...
Führen Sie nach der Installation das interaktive Installationsprogramm aus, um TLS, Init-Services (systemd/OpenRC/SysV) und die Datenbank zu konfigurieren:

...
Скачайте `.deb`-пакет напрямую из [последнего релиза на GitHub](https://github.com/themadorg/bedrud/releases/latest):
...
Скачайте `.rpm`-пакет из [последнего релиза на GitHub](https://github.com/themadorg/bedrud/releases/latest):
...
<Tabs>
  ...
  <TabsContent value="nsis">
    Скачайте и запустите установщик из [последнего релиза](https://github.com/themadorg/bedrud/releases/latest):
...
| `HOMEBREW_TAP_TOKEN` | Homebrew tap | GitHub PAT с доступом на запись в `themadorg/homebrew-bedrud` |

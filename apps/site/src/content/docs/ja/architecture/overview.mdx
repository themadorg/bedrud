...
See [Server Architecture](/ja/docs/architecture/server) for details.
...
See [Web Frontend](/ja/docs/architecture/web) for details.
...
See [Android App](/ja/docs/architecture/android) for details.
...
See [iOS App](/ja/docs/architecture/ios) for details.
...
See [Desktop App](/ja/docs/architecture/desktop) for details.
...
See [Bot Agents](/ja/docs/architecture/agents) for details.
...
See [Deployment Guide](/ja/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/ja/docs/architecture/turn-server) - TURN relay architecture and configuration

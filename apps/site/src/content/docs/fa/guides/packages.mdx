...
بسته `.deb` را مستقیماً از [آخرین انتشار GitHub](https://github.com/themadorg/bedrud/releases/latest) دانلود کنید:
...
بسته `.rpm` را از [آخرین انتشار GitHub](https://github.com/themadorg/bedrud/releases/latest) دانلود کنید:
...
<Tabs>
  ...
  <TabsContent value="x86-64">
    ```bash
    sudo dnf install https://github.com/themadorg/bedrud/releases/latest/download/bedrud_*.x86_64.rpm
    ```
  </TabsContent>

  <TabsContent value="aarch64">
    ```bash
    sudo dnf install https://github.com/themadorg/bedrud/releases/latest/download/bedrud_*.aarch64.rpm
    ```
  </TabsContent>
</Tabs>
...
<Tabs>
  ...
  <TabsContent value="nsis">
    نصب‌کننده را از [آخرین انتشار](https://github.com/themadorg/bedrud/releases/latest) دانلود و اجرا کنید:
...
| `HOMEBREW_TAP_TOKEN` | tap Homebrew | GitHub PAT با دسترسی نوشتن به `themadorg/homebrew-bedrud` |

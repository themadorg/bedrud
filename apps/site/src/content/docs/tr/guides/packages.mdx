...
`.deb` paketini doğrudan [en son GitHub sürümünden](https://github.com/themadorg/bedrud/releases/latest) indirin:
...
`.rpm` paketini [en son GitHub sürümünden](https://github.com/themadorg/bedrud/releases/latest) indirin:
...
<Tabs>
  ...
  <TabsContent value="nsis">
    [En son sürümden](https://github.com/themadorg/bedrud/releases/latest) yükleyiciyi indirip çalıştırın:
...
| `HOMEBREW_TAP_TOKEN`           | Homebrew tap | `themadorg/homebrew-bedrud` deposuna yazma erişimli GitHub PAT |

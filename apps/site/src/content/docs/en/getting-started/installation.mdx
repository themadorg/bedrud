...
<Tabs>
  ...
  <TabsContent value="alpine-apk">
    ...
    Download the `.apk` package from the [latest release](https://github.com/bedrud-ir/bedrud/releases/latest):
...
```bash
docker pull ghcr.io/bedrud-ir/bedrud:latest
# or: docker pull ghcr.io/bedrud-ir/bedrud:latest-alpine
# or: docker pull ghcr.io/bedrud-ir/bedrud:latest-distroless

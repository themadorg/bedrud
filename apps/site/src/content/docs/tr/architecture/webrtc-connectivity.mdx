...
For deep TURN troubleshooting, see the [TURN Server Guide](/tr/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/tr/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/tr/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/tr/docs/architecture/overview) - full system architecture

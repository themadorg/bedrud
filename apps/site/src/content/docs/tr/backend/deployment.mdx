...
Prints the installed version and the version it is moving to before stopping anything, then replaces the binary, runs versioned install migrations and DB AutoMigrate, refreshes init units, and restarts services. See [Updating](/tr/docs/getting-started/installation#updating).
...
- [Deployment Guide](/tr/docs/guides/deployment) - full production deployment instructions
- [Appliance Mode](/tr/docs/guides/appliance) - single-binary setup reference

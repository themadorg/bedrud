---
title: مرجع CLI
description: توثيق واجهة سطر الأوامر
order: 5
---
...
**Related docs:** [Installation Guide](/ar/docs/getting-started/installation) • [Deployment Guide](/ar/docs/guides/deployment) • [Backend Deployment Logic](/ar/docs/backend/deployment)
...
**Related docs:** [Installation Guide - Updating](/ar/docs/getting-started/installation#updating) • [Appliance Mode](/ar/docs/guides/appliance)
...
**Related docs:** [Installation Guide - Uninstalling](/ar/docs/getting-started/installation#uninstallation)
...
- [Installation Guide](/ar/docs/getting-started/installation) - Detailed `bedrud install` walkthrough, TLS topologies, post-install steps
- [Configuration Reference](/ar/docs/getting-started/configuration) - Server and LiveKit config file structure
- [Backend Deployment Logic](/ar/docs/backend/deployment) - How `install` and `uninstall` work internally
- [Deployment Guide](/ar/docs/guides/deployment) - Full deployment options including init system services

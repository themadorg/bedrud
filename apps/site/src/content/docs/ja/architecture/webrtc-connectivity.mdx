...
For deep TURN troubleshooting, see the [TURN Server Guide](/ja/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/ja/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/ja/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/ja/docs/architecture/overview) - full system architecture

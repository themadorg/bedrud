...
> **Nota:** La guía de contribución oficial se encuentra en la raíz del repositorio: [CONTRIBUTING.md](https://github.com/themadorg/bedrud/blob/main/CONTRIBUTING.md). Esta página se conserva únicamente como referencia.
...
Abre issues en [GitHub Issues](https://github.com/themadorg/bedrud/issues) incluyendo:
...
Al contribuir, aceptas que tus contribuciones se licenciarán bajo la [Licencia Apache 2.0](https://github.com/themadorg/bedrud/blob/main/LICENSE).

export default {
  ...
  docs: {
    ...
    sidebarItems: {
      ...
      "using/account-and-settings": "Hesap ve Ayarlar",
      "using/dashboard-and-rooms": "Pano ve Odalar",
      "using/joining-a-meeting": "Toplantıya Katılma",
      "using/stage-mode": "Sahne Modu",
      "using/whiteboard": "Ortak Beyaz Tahta",
      "using/youtube-watch": "YouTube İzleme",
      "using/chat": "Toplantı İçi Sohbet",
      "using/audio-and-push-to-talk": "Ses ve Bas-Konuş",
      "using/meeting-controls": "Toplantı Kontrolleri",
  ...
  downloadPage: {
    ...
    dockerRunDesc: "Docker veya Podman ile konteynerda çalıştırın.",
    dockerComposeDesc: "Kolay yönetim için Docker Compose ile dağıtın.",
    dockerQuickStart: "Hızlı Başlangıç",
    dockerQuickStartDesc:
      "Tek komutla Bedrud sunucusunu çalıştırın. Web arayüzü 8090 portunda, WebRTC 7880 portunda.",
    dockerCopyRun: "docker run kopyala",
    dockerPodmanDesc:
      "Docker'ın rootsuz alternatifi. Aynı komutlar, sadece docker yerine podman yazın.",
    dockerVariantsTitle: "İmaj Çeşitleri",
    dockerVariantsDesc:
      "Güvenlik ve boyut gereksinimlerinize uygun temel imajı seçin.",
    dockerVariantDefault: "varsayılan",
    dockerVariantSmall: "daha küçük",
    dockerVariantMinimal: "minimal saldırı yüzeyi",
    dockerPortsTitle: "Portlar ve Birimler",
    dockerPortWeb: "Web arayüzü ve API",
    dockerPortRTC: "WebRTC (medya)",
    dockerVolumeDesc: "Yapılandırma ve SQLite veritabanı",
    dockerEnvDesc: "CONFIG_PATH, dinleme portu vb.",
    dockerPortUDP: "WebRTC medya portları (UDP)",
    dockerGuide: "Tam Docker kılavuzu",
    platform: {
      linux: "Linux",
      mac: "macOS",
      windows: "Windows",

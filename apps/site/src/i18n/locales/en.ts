export default {
  ...
  downloadPage: {
    ...
    dockerRunDesc: "Run in a container with Docker or Podman.",
    dockerComposeDesc: "Deploy with Docker Compose for easy management.",
    dockerQuickStart: "Quick Start",
    dockerQuickStartDesc:
      "Pull and run Bedrud server in a single command. Web UI on port 8090, WebRTC on port 7880.",
    dockerCopyRun: "Copy docker run",
    dockerPodmanDesc:
      "Rootless alternative to Docker. Same commands, just replace docker with podman.",
    dockerVariantsTitle: "Image Variants",
    dockerVariantsDesc:
      "Choose the base image that fits your security and size requirements.",
    dockerVariantDefault: "default",
    dockerVariantSmall: "smaller",
    dockerVariantMinimal: "minimal attack surface",
    dockerPortsTitle: "Ports & Volumes",
    dockerPortWeb: "Web UI & API",
    dockerPortRTC: "WebRTC (media)",
    dockerVolumeDesc: "Config & SQLite database",
    dockerEnvDesc: "CONFIG_PATH, listen port, etc.",
    dockerPortUDP: "WebRTC media ports (UDP)",
    dockerGuide: "Full Docker guide",
    platform: {
      linux: "Linux",
      mac: "macOS",
      windows: "Windows",

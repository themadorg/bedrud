...
| [Appliance Mode](/tr/docs/guides/appliance) | Single-binary all-in-one setup |
...
See the [Package Installation guide](/tr/docs/guides/packages) for full instructions, including adding the apt GPG key and repository.
...
See the [Installation Guide](/tr/docs/getting-started/installation) for all installation scenarios.
...
See the [Docker Guide](/tr/docs/guides/docker) for full details including volumes, configuration, and Docker Compose.

...
For deep TURN troubleshooting, see the [TURN Server Guide](/fa/docs/architecture/turn-server).

---

## See also

- [TURN Server Guide](/fa/docs/architecture/turn-server) - TURN architecture, configuration, TLS, debugging
- [LiveKit Integration](/fa/docs/backend/livekit) - how Bedrud embeds LiveKit
- [Architecture Overview](/fa/docs/architecture/overview) - full system architecture

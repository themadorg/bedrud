...
Shared product concepts (stage, chat, whiteboard on web) are documented under [Using Bedrud](/ar/docs/using/joining-a-meeting). Feature parity with web may differ by release.

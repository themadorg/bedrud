...
Download the Alpine package from the [latest release](https://github.com/bedrud-ir/bedrud/releases/latest):
...
# ARM64 (aarch64)
wget https://github.com/bedrud-ir/bedrud/releases/latest/download/bedrud_aarch64.apk
...
| Docker | `ghcr.io/bedrud-ir/bedrud` (`:latest` / `:latest-alpine`) | - |

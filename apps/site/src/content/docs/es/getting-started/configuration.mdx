...
**Ubicación:** `server/livekit.yaml` (desarrollo) o `/etc/bedrud/livekit.yaml` (producción)

<Tabs>
  <TabsList>
    <TabsTrigger value="production">Producción / Externo (Estándar)</TabsTrigger>
    <TabsTrigger value="development">Desarrollo Local (Loopback)</TabsTrigger>
  </TabsList>
...
| `LIVEKIT_API_KEY` | `livekit.apiKey` | API key de LiveKit (auto-generated as `gen-<32hex>` if empty) |
| `LIVEKIT_API_SECRET` | `livekit.apiSecret` | API secret de LiveKit (64-char hex auto-generated if empty) |
